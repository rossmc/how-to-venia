...
import CartTrigger from 'src/components/Header/cartTrigger';
import NavTrigger from 'src/components/Header/navTrigger';
import SearchTrigger from 'src/components/Header/searchTrigger';
